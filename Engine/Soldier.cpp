...
void Soldier::DrawWithRifle(Graphics & gfx) const
{
	if (!isDead())
	{
...
void Soldier::DrawWithPistol(Graphics & gfx) const
{
	const int in_x = int(pos.x);
	const int in_y = int(pos.y);

	gfx.PutPixel(8 + in_x, 2 + in_y, 10, 10, 10);
	gfx.PutPixel(9 + in_x, 2 + in_y, 17, 17, 17);
	gfx.PutPixel(10 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(11 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(12 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(13 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(14 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(15 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(16 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(17 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(18 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(19 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(20 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(21 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(22 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(23 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(24 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(25 + in_x, 2 + in_y, 16, 16, 16);
	gfx.PutPixel(26 + in_x, 2 + in_y, 17, 17, 17);
	gfx.PutPixel(27 + in_x, 2 + in_y, 11, 11, 11);
	gfx.PutPixel(8 + in_x, 3 + in_y, 39, 39, 39);
	gfx.PutPixel(9 + in_x, 3 + in_y, 66, 66, 66);
	gfx.PutPixel(10 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(11 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(12 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(13 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(14 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(15 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(16 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(17 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(18 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(19 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(20 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(21 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(22 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(23 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(24 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(25 + in_x, 3 + in_y, 63, 63, 63);
	gfx.PutPixel(26 + in_x, 3 + in_y, 66, 66, 66);
	gfx.PutPixel(27 + in_x, 3 + in_y, 47, 47, 47);
	gfx.PutPixel(8 + in_x, 4 + in_y, 37, 37, 37);
	gfx.PutPixel(9 + in_x, 4 + in_y, 64, 64, 64);
	gfx.PutPixel(10 + in_x, 4 + in_y, 61, 61, 61);
	gfx.PutPixel(11 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(12 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(13 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(14 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(15 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(16 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(17 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(18 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(19 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(20 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(21 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(22 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(23 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(24 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(25 + in_x, 4 + in_y, 60, 60, 60);
	gfx.PutPixel(26 + in_x, 4 + in_y, 63, 63, 63);
	gfx.PutPixel(27 + in_x, 4 + in_y, 43, 43, 43);
	gfx.PutPixel(5 + in_x, 5 + in_y, 12, 12, 12);
	gfx.PutPixel(6 + in_x, 5 + in_y, 32, 32, 32);
	gfx.PutPixel(7 + in_x, 5 + in_y, 31, 31, 31);
	gfx.PutPixel(8 + in_x, 5 + in_y, 50, 50, 50);
	gfx.PutPixel(9 + in_x, 5 + in_y, 63, 63, 63);
	gfx.PutPixel(10 + in_x, 5 + in_y, 61, 61, 61);
	gfx.PutPixel(11 + in_x, 5 + in_y, 71, 71, 71);
	gfx.PutPixel(12 + in_x, 5 + in_y, 74, 74, 74);
	gfx.PutPixel(13 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(14 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(15 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(16 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(17 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(18 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(19 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(20 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(21 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(22 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(23 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(24 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(25 + in_x, 5 + in_y, 73, 73, 73);
	gfx.PutPixel(26 + in_x, 5 + in_y, 75, 75, 75);
	gfx.PutPixel(27 + in_x, 5 + in_y, 65, 65, 65);
	gfx.PutPixel(28 + in_x, 5 + in_y, 43, 43, 43);
	gfx.PutPixel(29 + in_x, 5 + in_y, 45, 45, 45);
	gfx.PutPixel(30 + in_x, 5 + in_y, 22, 22, 22);
	gfx.PutPixel(5 + in_x, 6 + in_y, 24, 24, 24);
	gfx.PutPixel(6 + in_x, 6 + in_y, 68, 68, 68);
	gfx.PutPixel(7 + in_x, 6 + in_y, 65, 65, 65);
	gfx.PutPixel(8 + in_x, 6 + in_y, 62, 62, 62);
	gfx.PutPixel(9 + in_x, 6 + in_y, 61, 61, 61);
	gfx.PutPixel(10 + in_x, 6 + in_y, 61, 61, 61);
	gfx.PutPixel(11 + in_x, 6 + in_y, 82, 82, 82);
	gfx.PutPixel(12 + in_x, 6 + in_y, 88, 88, 88);
	gfx.PutPixel(13 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(14 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(15 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(16 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(17 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(18 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(19 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(20 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(21 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(22 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(23 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(24 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(25 + in_x, 6 + in_y, 87, 87, 87);
	gfx.PutPixel(26 + in_x, 6 + in_y, 86, 86, 86);
	gfx.PutPixel(27 + in_x, 6 + in_y, 88, 88, 88);
	gfx.PutPixel(28 + in_x, 6 + in_y, 90, 90, 90);
	gfx.PutPixel(29 + in_x, 6 + in_y, 96, 96, 96);
	gfx.PutPixel(30 + in_x, 6 + in_y, 46, 46, 46);
	gfx.PutPixel(5 + in_x, 7 + in_y, 23, 23, 23);
	gfx.PutPixel(6 + in_x, 7 + in_y, 64, 64, 64);
	gfx.PutPixel(7 + in_x, 7 + in_y, 61, 61, 61);
	gfx.PutPixel(8 + in_x, 7 + in_y, 60, 60, 60);
	gfx.PutPixel(9 + in_x, 7 + in_y, 60, 60, 60);
	gfx.PutPixel(10 + in_x, 7 + in_y, 60, 60, 60);
	gfx.PutPixel(11 + in_x, 7 + in_y, 81, 81, 81);
	gfx.PutPixel(12 + in_x, 7 + in_y, 86, 86, 86);
	gfx.PutPixel(13 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(14 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(15 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(16 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(17 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(18 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(19 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(20 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(21 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(22 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(23 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(24 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(25 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(26 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(27 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(28 + in_x, 7 + in_y, 85, 85, 85);
	gfx.PutPixel(29 + in_x, 7 + in_y, 90, 90, 90);
	gfx.PutPixel(30 + in_x, 7 + in_y, 43, 43, 43);
	gfx.PutPixel(5 + in_x, 8 + in_y, 23, 23, 23);
	gfx.PutPixel(6 + in_x, 8 + in_y, 64, 64, 64);
	gfx.PutPixel(7 + in_x, 8 + in_y, 60, 60, 60);
	gfx.PutPixel(8 + in_x, 8 + in_y, 72, 72, 72);
	gfx.PutPixel(9 + in_x, 8 + in_y, 80, 80, 80);
	gfx.PutPixel(10 + in_x, 8 + in_y, 79, 79, 79);
	gfx.PutPixel(11 + in_x, 8 + in_y, 84, 84, 84);
	gfx.PutPixel(12 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(13 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(14 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(15 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(16 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(17 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(18 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(19 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(20 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(21 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(22 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(23 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(24 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(25 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(26 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(27 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(28 + in_x, 8 + in_y, 85, 85, 85);
	gfx.PutPixel(29 + in_x, 8 + in_y, 90, 90, 90);
	gfx.PutPixel(30 + in_x, 8 + in_y, 43, 43, 43);
	gfx.PutPixel(5 + in_x, 9 + in_y, 23, 23, 23);
	gfx.PutPixel(6 + in_x, 9 + in_y, 65, 65, 65);
	gfx.PutPixel(7 + in_x, 9 + in_y, 61, 61, 61);
	gfx.PutPixel(8 + in_x, 9 + in_y, 78, 78, 78);
	gfx.PutPixel(9 + in_x, 9 + in_y, 89, 89, 89);
	gfx.PutPixel(10 + in_x, 9 + in_y, 88, 88, 88);
	gfx.PutPixel(11 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(12 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(13 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(14 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(15 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(16 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(17 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(18 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(19 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(20 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(21 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(22 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(23 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(24 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(25 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(26 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(27 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(28 + in_x, 9 + in_y, 87, 87, 87);
	gfx.PutPixel(29 + in_x, 9 + in_y, 92, 92, 92);
	gfx.PutPixel(30 + in_x, 9 + in_y, 43, 43, 43);
	gfx.PutPixel(3 + in_x, 10 + in_y, 4, 4, 4);
	gfx.PutPixel(4 + in_x, 10 + in_y, 5, 5, 5);
	gfx.PutPixel(5 + in_x, 10 + in_y, 24, 24, 24);
	gfx.PutPixel(6 + in_x, 10 + in_y, 59, 59, 59);
	gfx.PutPixel(7 + in_x, 10 + in_y, 56, 56, 56);
	gfx.PutPixel(8 + in_x, 10 + in_y, 71, 71, 71);
	gfx.PutPixel(9 + in_x, 10 + in_y, 80, 80, 80);
	gfx.PutPixel(10 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(11 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(12 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(13 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(14 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(15 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(16 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(17 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(18 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(19 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(20 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(21 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(22 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(23 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(24 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(25 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(26 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(27 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(28 + in_x, 10 + in_y, 79, 79, 79);
	gfx.PutPixel(29 + in_x, 10 + in_y, 84, 84, 84);
	gfx.PutPixel(30 + in_x, 10 + in_y, 43, 43, 43);
	gfx.PutPixel(31 + in_x, 10 + in_y, 6, 6, 6);
	gfx.PutPixel(32 + in_x, 10 + in_y, 6, 6, 6);
	gfx.PutPixel(33 + in_x, 10 + in_y, 3, 3, 3);
	gfx.PutPixel(2 + in_x, 11 + in_y, 8, 8, 8);
	gfx.PutPixel(3 + in_x, 11 + in_y, 56, 56, 56);
	gfx.PutPixel(4 + in_x, 11 + in_y, 60, 60, 60);
	gfx.PutPixel(5 + in_x, 11 + in_y, 37, 37, 37);
	gfx.PutPixel(6 + in_x, 11 + in_y, 5, 5, 5);
	gfx.PutPixel(7 + in_x, 11 + in_y, 4, 4, 4);
	gfx.PutPixel(8 + in_x, 11 + in_y, 5, 5, 5);
	gfx.PutPixel(9 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(10 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(11 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(12 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(13 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(14 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(15 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(16 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(17 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(18 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(19 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(20 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(21 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(22 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(23 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(24 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(25 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(26 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(27 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(28 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(29 + in_x, 11 + in_y, 6, 6, 6);
	gfx.PutPixel(30 + in_x, 11 + in_y, 43, 43, 43);
	gfx.PutPixel(31 + in_x, 11 + in_y, 85, 85, 85);
	gfx.PutPixel(32 + in_x, 11 + in_y, 82, 82, 82);
	gfx.PutPixel(33 + in_x, 11 + in_y, 20, 20, 20);
	gfx.PutPixel(2 + in_x, 12 + in_y, 10, 10, 10);
	gfx.PutPixel(3 + in_x, 12 + in_y, 61, 61, 61);
	gfx.PutPixel(4 + in_x, 12 + in_y, 66, 66, 66);
	gfx.PutPixel(5 + in_x, 12 + in_y, 38, 38, 38);
	gfx.PutPixel(30 + in_x, 12 + in_y, 43, 43, 43);
	gfx.PutPixel(31 + in_x, 12 + in_y, 93, 93, 93);
	gfx.PutPixel(32 + in_x, 12 + in_y, 90, 90, 90);
	gfx.PutPixel(33 + in_x, 12 + in_y, 22, 22, 22);
	gfx.PutPixel(2 + in_x, 13 + in_y, 10, 10, 10);
	gfx.PutPixel(3 + in_x, 13 + in_y, 60, 60, 60);
	gfx.PutPixel(4 + in_x, 13 + in_y, 65, 65, 65);
	gfx.PutPixel(5 + in_x, 13 + in_y, 38, 38, 38);
	gfx.PutPixel(8 + in_x, 13 + in_y, 41, 30, 20);
	gfx.PutPixel(9 + in_x, 13 + in_y, 66, 51, 35);
	gfx.PutPixel(10 + in_x, 13 + in_y, 65, 48, 33);
	gfx.PutPixel(11 + in_x, 13 + in_y, 11, 8, 5);
	gfx.PutPixel(13 + in_x, 13 + in_y, 5, 3, 2);
	gfx.PutPixel(14 + in_x, 13 + in_y, 61, 45, 31);
	gfx.PutPixel(15 + in_x, 13 + in_y, 66, 49, 34);
	gfx.PutPixel(16 + in_x, 13 + in_y, 66, 48, 33);
	gfx.PutPixel(17 + in_x, 13 + in_y, 66, 48, 33);
	gfx.PutPixel(18 + in_x, 13 + in_y, 66, 48, 33);
	gfx.PutPixel(19 + in_x, 13 + in_y, 66, 48, 33);
	gfx.PutPixel(20 + in_x, 13 + in_y, 66, 48, 33);
	gfx.PutPixel(21 + in_x, 13 + in_y, 66, 50, 34);
	gfx.PutPixel(22 + in_x, 13 + in_y, 17, 12, 9);
	gfx.PutPixel(24 + in_x, 13 + in_y, 5, 3, 2);
	gfx.PutPixel(25 + in_x, 13 + in_y, 61, 45, 31);
	gfx.PutPixel(26 + in_x, 13 + in_y, 66, 51, 35);
	gfx.PutPixel(27 + in_x, 13 + in_y, 49, 36, 25);
	gfx.PutPixel(30 + in_x, 13 + in_y, 43, 43, 43);
	gfx.PutPixel(31 + in_x, 13 + in_y, 91, 91, 91);
	gfx.PutPixel(32 + in_x, 13 + in_y, 88, 88, 88);
	gfx.PutPixel(33 + in_x, 13 + in_y, 22, 22, 22);
	gfx.PutPixel(2 + in_x, 14 + in_y, 10, 10, 10);
	gfx.PutPixel(3 + in_x, 14 + in_y, 60, 60, 60);
	gfx.PutPixel(4 + in_x, 14 + in_y, 65, 65, 65);
	gfx.PutPixel(5 + in_x, 14 + in_y, 38, 38, 38);
	gfx.PutPixel(8 + in_x, 14 + in_y, 164, 120, 82);
	gfx.PutPixel(9 + in_x, 14 + in_y, 255, 206, 141);
	gfx.PutPixel(10 + in_x, 14 + in_y, 255, 191, 131);
	gfx.PutPixel(11 + in_x, 14 + in_y, 44, 32, 22);
	gfx.PutPixel(13 + in_x, 14 + in_y, 19, 13, 9);
	gfx.PutPixel(14 + in_x, 14 + in_y, 245, 180, 123);
	gfx.PutPixel(15 + in_x, 14 + in_y, 255, 198, 135);
	gfx.PutPixel(16 + in_x, 14 + in_y, 255, 194, 133);
	gfx.PutPixel(17 + in_x, 14 + in_y, 255, 194, 133);
	gfx.PutPixel(18 + in_x, 14 + in_y, 255, 194, 133);
	gfx.PutPixel(19 + in_x, 14 + in_y, 255, 194, 133);
	gfx.PutPixel(20 + in_x, 14 + in_y, 255, 194, 133);
	gfx.PutPixel(21 + in_x, 14 + in_y, 255, 201, 138);
	gfx.PutPixel(22 + in_x, 14 + in_y, 68, 50, 34);
	gfx.PutPixel(24 + in_x, 14 + in_y, 19, 13, 9);
	gfx.PutPixel(25 + in_x, 14 + in_y, 245, 180, 123);
	gfx.PutPixel(26 + in_x, 14 + in_y, 255, 206, 141);
	gfx.PutPixel(27 + in_x, 14 + in_y, 196, 144, 98);
	gfx.PutPixel(30 + in_x, 14 + in_y, 43, 43, 43);
	gfx.PutPixel(31 + in_x, 14 + in_y, 91, 91, 91);
	gfx.PutPixel(32 + in_x, 14 + in_y, 88, 88, 88);
	gfx.PutPixel(33 + in_x, 14 + in_y, 22, 22, 22);
	gfx.PutPixel(2 + in_x, 15 + in_y, 11, 11, 11);
	gfx.PutPixel(3 + in_x, 15 + in_y, 64, 64, 64);
	gfx.PutPixel(4 + in_x, 15 + in_y, 69, 69, 69);
	gfx.PutPixel(5 + in_x, 15 + in_y, 34, 36, 37);
	gfx.PutPixel(8 + in_x, 15 + in_y, 152, 112, 76);
	gfx.PutPixel(9 + in_x, 15 + in_y, 255, 200, 137);
	gfx.PutPixel(10 + in_x, 15 + in_y, 252, 184, 126);
	gfx.PutPixel(11 + in_x, 15 + in_y, 42, 31, 21);
	gfx.PutPixel(13 + in_x, 15 + in_y, 18, 13, 9);
	gfx.PutPixel(14 + in_x, 15 + in_y, 238, 174, 119);
	gfx.PutPixel(15 + in_x, 15 + in_y, 255, 191, 130);
	gfx.PutPixel(16 + in_x, 15 + in_y, 255, 187, 128);
	gfx.PutPixel(17 + in_x, 15 + in_y, 255, 187, 128);
	gfx.PutPixel(18 + in_x, 15 + in_y, 255, 187, 128);
	gfx.PutPixel(19 + in_x, 15 + in_y, 255, 187, 128);
	gfx.PutPixel(20 + in_x, 15 + in_y, 255, 187, 128);
	gfx.PutPixel(21 + in_x, 15 + in_y, 255, 194, 133);
	gfx.PutPixel(22 + in_x, 15 + in_y, 66, 48, 33);
	gfx.PutPixel(24 + in_x, 15 + in_y, 18, 13, 9);
	gfx.PutPixel(25 + in_x, 15 + in_y, 238, 174, 119);
	gfx.PutPixel(26 + in_x, 15 + in_y, 255, 200, 137);
	gfx.PutPixel(27 + in_x, 15 + in_y, 185, 136, 93);
	gfx.PutPixel(30 + in_x, 15 + in_y, 38, 40, 42);
	gfx.PutPixel(31 + in_x, 15 + in_y, 97, 97, 97);
	gfx.PutPixel(32 + in_x, 15 + in_y, 94, 94, 94);
	gfx.PutPixel(33 + in_x, 15 + in_y, 23, 23, 23);
	gfx.PutPixel(2 + in_x, 16 + in_y, 5, 5, 5);
	gfx.PutPixel(3 + in_x, 16 + in_y, 30, 30, 30);
	gfx.PutPixel(4 + in_x, 16 + in_y, 33, 33, 33);
	gfx.PutPixel(5 + in_x, 16 + in_y, 68, 55, 44);
	gfx.PutPixel(6 + in_x, 16 + in_y, 128, 98, 67);
	gfx.PutPixel(7 + in_x, 16 + in_y, 128, 94, 64);
	gfx.PutPixel(8 + in_x, 16 + in_y, 207, 152, 104);
	gfx.PutPixel(9 + in_x, 16 + in_y, 255, 194, 133);
	gfx.PutPixel(10 + in_x, 16 + in_y, 251, 184, 126);
	gfx.PutPixel(11 + in_x, 16 + in_y, 42, 31, 21);
	gfx.PutPixel(13 + in_x, 16 + in_y, 18, 13, 9);
	gfx.PutPixel(14 + in_x, 16 + in_y, 237, 174, 119);
	gfx.PutPixel(15 + in_x, 16 + in_y, 255, 191, 130);
	gfx.PutPixel(16 + in_x, 16 + in_y, 255, 187, 128);
	gfx.PutPixel(17 + in_x, 16 + in_y, 255, 187, 128);
	gfx.PutPixel(18 + in_x, 16 + in_y, 255, 187, 128);
	gfx.PutPixel(19 + in_x, 16 + in_y, 255, 187, 128);
	gfx.PutPixel(20 + in_x, 16 + in_y, 255, 187, 128);
	gfx.PutPixel(21 + in_x, 16 + in_y, 255, 194, 133);
	gfx.PutPixel(22 + in_x, 16 + in_y, 66, 48, 33);
	gfx.PutPixel(24 + in_x, 16 + in_y, 18, 13, 9);
	gfx.PutPixel(25 + in_x, 16 + in_y, 237, 174, 119);
	gfx.PutPixel(26 + in_x, 16 + in_y, 255, 195, 133);
	gfx.PutPixel(27 + in_x, 16 + in_y, 222, 163, 112);
	gfx.PutPixel(28 + in_x, 16 + in_y, 128, 94, 64);
	gfx.PutPixel(29 + in_x, 16 + in_y, 128, 100, 68);
	gfx.PutPixel(30 + in_x, 16 + in_y, 86, 69, 54);
	gfx.PutPixel(31 + in_x, 16 + in_y, 46, 46, 46);
	gfx.PutPixel(32 + in_x, 16 + in_y, 44, 44, 44);
	gfx.PutPixel(33 + in_x, 16 + in_y, 11, 11, 11);
	gfx.PutPixel(5 + in_x, 17 + in_y, 101, 73, 50);
	gfx.PutPixel(6 + in_x, 17 + in_y, 255, 209, 143);
	gfx.PutPixel(7 + in_x, 17 + in_y, 255, 199, 136);
	gfx.PutPixel(8 + in_x, 17 + in_y, 255, 192, 131);
	gfx.PutPixel(9 + in_x, 17 + in_y, 255, 188, 129);
	gfx.PutPixel(10 + in_x, 17 + in_y, 251, 184, 126);
	gfx.PutPixel(11 + in_x, 17 + in_y, 40, 29, 20);
	gfx.PutPixel(13 + in_x, 17 + in_y, 15, 11, 8);
	gfx.PutPixel(14 + in_x, 17 + in_y, 237, 174, 119);
	gfx.PutPixel(15 + in_x, 17 + in_y, 255, 191, 130);
	gfx.PutPixel(16 + in_x, 17 + in_y, 255, 187, 128);
	gfx.PutPixel(17 + in_x, 17 + in_y, 255, 187, 128);
	gfx.PutPixel(18 + in_x, 17 + in_y, 255, 187, 128);
	gfx.PutPixel(19 + in_x, 17 + in_y, 255, 187, 128);
	gfx.PutPixel(20 + in_x, 17 + in_y, 255, 187, 128);
	gfx.PutPixel(21 + in_x, 17 + in_y, 255, 194, 133);
	gfx.PutPixel(22 + in_x, 17 + in_y, 64, 46, 32);
	gfx.PutPixel(24 + in_x, 17 + in_y, 15, 11, 8);
	gfx.PutPixel(25 + in_x, 17 + in_y, 237, 174, 119);
	gfx.PutPixel(26 + in_x, 17 + in_y, 255, 191, 130);
	gfx.PutPixel(27 + in_x, 17 + in_y, 255, 190, 130);
	gfx.PutPixel(28 + in_x, 17 + in_y, 255, 199, 136);
	gfx.PutPixel(29 + in_x, 17 + in_y, 255, 212, 145);
	gfx.PutPixel(30 + in_x, 17 + in_y, 133, 97, 65);
	gfx.PutPixel(5 + in_x, 18 + in_y, 97, 71, 49);
	gfx.PutPixel(6 + in_x, 18 + in_y, 255, 196, 134);
	gfx.PutPixel(7 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(8 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(9 + in_x, 18 + in_y, 255, 189, 129);
	gfx.PutPixel(10 + in_x, 18 + in_y, 251, 184, 126);
	gfx.PutPixel(11 + in_x, 18 + in_y, 46, 34, 23);
	gfx.PutPixel(12 + in_x, 18 + in_y, 4, 3, 2);
	gfx.PutPixel(13 + in_x, 18 + in_y, 22, 16, 11);
	gfx.PutPixel(14 + in_x, 18 + in_y, 237, 174, 119);
	gfx.PutPixel(15 + in_x, 18 + in_y, 255, 191, 130);
	gfx.PutPixel(16 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(17 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(18 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(19 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(20 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(21 + in_x, 18 + in_y, 255, 194, 133);
	gfx.PutPixel(22 + in_x, 18 + in_y, 69, 50, 35);
	gfx.PutPixel(23 + in_x, 18 + in_y, 5, 3, 2);
	gfx.PutPixel(24 + in_x, 18 + in_y, 22, 16, 11);
	gfx.PutPixel(25 + in_x, 18 + in_y, 237, 174, 119);
	gfx.PutPixel(26 + in_x, 18 + in_y, 255, 191, 130);
	gfx.PutPixel(27 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(28 + in_x, 18 + in_y, 255, 187, 128);
	gfx.PutPixel(29 + in_x, 18 + in_y, 255, 199, 136);
	gfx.PutPixel(30 + in_x, 18 + in_y, 128, 94, 64);
	gfx.PutPixel(5 + in_x, 19 + in_y, 97, 71, 49);
	gfx.PutPixel(6 + in_x, 19 + in_y, 255, 196, 134);
	gfx.PutPixel(7 + in_x, 19 + in_y, 255, 187, 128);
	gfx.PutPixel(8 + in_x, 19 + in_y, 255, 187, 128);
	gfx.PutPixel(9 + in_x, 19 + in_y, 255, 187, 128);
	gfx.PutPixel(10 + in_x, 19 + in_y, 255, 187, 128);
	gfx.PutPixel(11 + in_x, 19 + in_y, 233, 172, 118);
	gfx.PutPixel(12 + in_x, 19 + in_y, 229, 169, 116);
	gfx.PutPixel(13 + in_x, 19 + in_y, 232, 171, 117);
	gfx.PutPixel(14 + in_x, 19 + in_y, 255, 197, 135);
	gfx.PutPixel(15 + in_x, 19 + in_y, 255, 200, 137);
	gfx.PutPixel(16 + in_x, 19 + in_y, 255, 200, 137);
	gfx.PutPixel(17 + in_x, 19 + in_y, 255, 200, 137);
	gfx.PutPixel(18 + in_x, 19 + in_y, 255, 200, 137);
	gfx.PutPixel(19 + in_x, 19 + in_y, 255, 200, 137);
	gfx.PutPixel(20 + in_x, 19 + in_y, 255, 200, 137);
	gfx.PutPixel(21 + in_x, 19 + in_y, 255, 201, 138);
	gfx.PutPixel(22 + in_x, 19 + in_y, 228, 167, 115);
	gfx.PutPixel(23 + in_x, 19 + in_y, 213, 156, 107);
	gfx.PutPixel(24 + in_x, 19 + in_y, 216, 158, 109);
	gfx.PutPixel(25 + in_x, 19 + in_y, 252, 185, 127);
	gfx.PutPixel(26 + in_x, 19 + in_y, 255, 188, 128);
	gfx.PutPixel(27 + in_x, 19 + in_y, 255, 187, 128);
	gfx.PutPixel(28 + in_x, 19 + in_y, 255, 187, 128);
	gfx.PutPixel(29 + in_x, 19 + in_y, 255, 199, 136);
	gfx.PutPixel(30 + in_x, 19 + in_y, 128, 94, 64);
	gfx.PutPixel(5 + in_x, 20 + in_y, 100, 73, 51);
	gfx.PutPixel(6 + in_x, 20 + in_y, 255, 202, 138);
	gfx.PutPixel(7 + in_x, 20 + in_y, 255, 193, 132);
	gfx.PutPixel(8 + in_x, 20 + in_y, 255, 189, 130);
	gfx.PutPixel(9 + in_x, 20 + in_y, 255, 188, 128);
	gfx.PutPixel(10 + in_x, 20 + in_y, 253, 186, 127);
	gfx.PutPixel(11 + in_x, 20 + in_y, 155, 115, 78);
	gfx.PutPixel(12 + in_x, 20 + in_y, 136, 99, 67);
	gfx.PutPixel(13 + in_x, 20 + in_y, 135, 100, 68);
	gfx.PutPixel(14 + in_x, 20 + in_y, 128, 94, 65);
	gfx.PutPixel(15 + in_x, 20 + in_y, 127, 94, 64);
	gfx.PutPixel(16 + in_x, 20 + in_y, 127, 94, 65);
	gfx.PutPixel(17 + in_x, 20 + in_y, 127, 94, 65);
	gfx.PutPixel(18 + in_x, 20 + in_y, 127, 94, 65);
	gfx.PutPixel(19 + in_x, 20 + in_y, 127, 94, 65);
	gfx.PutPixel(20 + in_x, 20 + in_y, 127, 94, 65);
	gfx.PutPixel(21 + in_x, 20 + in_y, 127, 93, 63);
	gfx.PutPixel(22 + in_x, 20 + in_y, 228, 168, 115);
	gfx.PutPixel(23 + in_x, 20 + in_y, 255, 198, 135);
	gfx.PutPixel(24 + in_x, 20 + in_y, 255, 193, 132);
	gfx.PutPixel(25 + in_x, 20 + in_y, 255, 187, 128);
	gfx.PutPixel(26 + in_x, 20 + in_y, 255, 187, 128);
	gfx.PutPixel(27 + in_x, 20 + in_y, 255, 189, 129);
	gfx.PutPixel(28 + in_x, 20 + in_y, 255, 193, 132);
	gfx.PutPixel(29 + in_x, 20 + in_y, 255, 206, 140);
	gfx.PutPixel(30 + in_x, 20 + in_y, 132, 97, 66);
	gfx.PutPixel(5 + in_x, 21 + in_y, 81, 59, 41);
	gfx.PutPixel(6 + in_x, 21 + in_y, 213, 164, 112);
	gfx.PutPixel(7 + in_x, 21 + in_y, 213, 156, 107);
	gfx.PutPixel(8 + in_x, 21 + in_y, 239, 175, 120);
	gfx.PutPixel(9 + in_x, 21 + in_y, 255, 191, 130);
	gfx.PutPixel(10 + in_x, 21 + in_y, 251, 184, 126);
	gfx.PutPixel(11 + in_x, 21 + in_y, 28, 21, 14);
	gfx.PutPixel(22 + in_x, 21 + in_y, 185, 136, 93);
	gfx.PutPixel(23 + in_x, 21 + in_y, 255, 197, 134);
	gfx.PutPixel(24 + in_x, 21 + in_y, 255, 187, 128);
	gfx.PutPixel(25 + in_x, 21 + in_y, 255, 187, 128);
	gfx.PutPixel(26 + in_x, 21 + in_y, 255, 189, 129);
	gfx.PutPixel(27 + in_x, 21 + in_y, 244, 179, 123);
	gfx.PutPixel(28 + in_x, 21 + in_y, 213, 156, 107);
	gfx.PutPixel(29 + in_x, 21 + in_y, 213, 166, 114);
	gfx.PutPixel(30 + in_x, 21 + in_y, 107, 79, 53);
	gfx.PutPixel(5 + in_x, 22 + in_y, 2, 1, 1);
	gfx.PutPixel(6 + in_x, 22 + in_y, 5, 3, 2);
	gfx.PutPixel(7 + in_x, 22 + in_y, 5, 3, 2);
	gfx.PutPixel(8 + in_x, 22 + in_y, 160, 117, 80);
	gfx.PutPixel(9 + in_x, 22 + in_y, 255, 199, 136);
	gfx.PutPixel(10 + in_x, 22 + in_y, 251, 184, 126);
	gfx.PutPixel(11 + in_x, 22 + in_y, 35, 26, 18);
	gfx.PutPixel(22 + in_x, 22 + in_y, 187, 137, 94);
	gfx.PutPixel(23 + in_x, 22 + in_y, 255, 196, 134);
	gfx.PutPixel(24 + in_x, 22 + in_y, 255, 187, 128);
	gfx.PutPixel(25 + in_x, 22 + in_y, 255, 187, 128);
	gfx.PutPixel(26 + in_x, 22 + in_y, 255, 196, 134);
	gfx.PutPixel(27 + in_x, 22 + in_y, 190, 140, 96);
	gfx.PutPixel(28 + in_x, 22 + in_y, 5, 3, 2);
	gfx.PutPixel(29 + in_x, 22 + in_y, 5, 4, 2);
	gfx.PutPixel(30 + in_x, 22 + in_y, 2, 2, 1);
	gfx.PutPixel(8 + in_x, 23 + in_y, 167, 123, 84);
	gfx.PutPixel(9 + in_x, 23 + in_y, 255, 210, 144);
	gfx.PutPixel(10 + in_x, 23 + in_y, 255, 198, 136);
	gfx.PutPixel(11 + in_x, 23 + in_y, 216, 159, 109);
	gfx.PutPixel(12 + in_x, 23 + in_y, 205, 151, 103);
	gfx.PutPixel(13 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(14 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(15 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(16 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(17 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(18 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(19 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(20 + in_x, 23 + in_y, 205, 151, 104);
	gfx.PutPixel(21 + in_x, 23 + in_y, 205, 151, 103);
	gfx.PutPixel(22 + in_x, 23 + in_y, 254, 187, 128);
	gfx.PutPixel(23 + in_x, 23 + in_y, 255, 201, 138);
	gfx.PutPixel(24 + in_x, 23 + in_y, 255, 199, 136);
	gfx.PutPixel(25 + in_x, 23 + in_y, 255, 199, 136);
	gfx.PutPixel(26 + in_x, 23 + in_y, 255, 209, 143);
	gfx.PutPixel(27 + in_x, 23 + in_y, 200, 147, 101);
	gfx.PutPixel(8 + in_x, 24 + in_y, 78, 58, 40);
	gfx.PutPixel(9 + in_x, 24 + in_y, 128, 98, 67);
	gfx.PutPixel(10 + in_x, 24 + in_y, 128, 94, 64);
	gfx.PutPixel(11 + in_x, 24 + in_y, 137, 101, 70);
	gfx.PutPixel(12 + in_x, 24 + in_y, 139, 103, 71);
	gfx.PutPixel(13 + in_x, 24 + in_y, 139, 102, 70);
	gfx.PutPixel(14 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(15 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(16 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(17 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(18 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(19 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(20 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(21 + in_x, 24 + in_y, 137, 100, 68);
	gfx.PutPixel(22 + in_x, 24 + in_y, 130, 95, 65);
	gfx.PutPixel(23 + in_x, 24 + in_y, 128, 93, 64);
	gfx.PutPixel(24 + in_x, 24 + in_y, 128, 94, 64);
	gfx.PutPixel(25 + in_x, 24 + in_y, 128, 94, 64);
	gfx.PutPixel(26 + in_x, 24 + in_y, 128, 98, 67);
	gfx.PutPixel(27 + in_x, 24 + in_y, 95, 70, 48);
	gfx.PutPixel(15 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(16 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(17 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(18 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(19 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(20 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(21 + in_x, 25 + in_y, 0, 0, 1);
	gfx.PutPixel(13 + in_x, 26 + in_y, 6, 6, 6);
	gfx.PutPixel(14 + in_x, 26 + in_y, 115, 115, 115);
	gfx.PutPixel(15 + in_x, 26 + in_y, 125, 125, 125);
	gfx.PutPixel(16 + in_x, 26 + in_y, 124, 124, 124);
	gfx.PutPixel(17 + in_x, 26 + in_y, 124, 124, 124);
	gfx.PutPixel(18 + in_x, 26 + in_y, 124, 124, 124);
	gfx.PutPixel(19 + in_x, 26 + in_y, 124, 124, 124);
	gfx.PutPixel(20 + in_x, 26 + in_y, 124, 124, 124);
	gfx.PutPixel(21 + in_x, 26 + in_y, 128, 128, 128);
	gfx.PutPixel(22 + in_x, 26 + in_y, 30, 30, 30);
	gfx.PutPixel(10 + in_x, 27 + in_y, 1, 1, 1);
	gfx.PutPixel(11 + in_x, 27 + in_y, 47, 47, 47);
	gfx.PutPixel(12 + in_x, 27 + in_y, 70, 70, 70);
	gfx.PutPixel(13 + in_x, 27 + in_y, 65, 65, 65);
	gfx.PutPixel(14 + in_x, 27 + in_y, 38, 38, 38);
	gfx.PutPixel(15 + in_x, 27 + in_y, 36, 36, 36);
	gfx.PutPixel(16 + in_x, 27 + in_y, 34, 34, 34);
	gfx.PutPixel(17 + in_x, 27 + in_y, 31, 31, 31);
	gfx.PutPixel(18 + in_x, 27 + in_y, 32, 32, 32);
	gfx.PutPixel(19 + in_x, 27 + in_y, 32, 32, 32);
	gfx.PutPixel(20 + in_x, 27 + in_y, 32, 32, 32);
	gfx.PutPixel(21 + in_x, 27 + in_y, 33, 33, 33);
	gfx.PutPixel(22 + in_x, 27 + in_y, 55, 55, 55);
	gfx.PutPixel(23 + in_x, 27 + in_y, 66, 66, 66);
	gfx.PutPixel(24 + in_x, 27 + in_y, 63, 63, 63);
	gfx.PutPixel(25 + in_x, 27 + in_y, 63, 63, 63);
	gfx.PutPixel(26 + in_x, 27 + in_y, 66, 66, 66);
	gfx.PutPixel(27 + in_x, 27 + in_y, 47, 47, 47);
	gfx.PutPixel(8 + in_x, 28 + in_y, 13, 13, 13);
	gfx.PutPixel(9 + in_x, 28 + in_y, 53, 53, 53);
	gfx.PutPixel(10 + in_x, 28 + in_y, 87, 87, 87);
	gfx.PutPixel(11 + in_x, 28 + in_y, 103, 103, 103);
	gfx.PutPixel(12 + in_x, 28 + in_y, 55, 55, 55);
	gfx.PutPixel(13 + in_x, 28 + in_y, 20, 20, 20);
	gfx.PutPixel(14 + in_x, 28 + in_y, 3, 3, 3);
	gfx.PutPixel(17 + in_x, 28 + in_y, 18, 18, 18);
	gfx.PutPixel(18 + in_x, 28 + in_y, 18, 18, 18);
	gfx.PutPixel(19 + in_x, 28 + in_y, 18, 18, 18);
	gfx.PutPixel(20 + in_x, 28 + in_y, 18, 18, 18);
	gfx.PutPixel(21 + in_x, 28 + in_y, 17, 17, 17);
	gfx.PutPixel(22 + in_x, 28 + in_y, 72, 72, 72);
	gfx.PutPixel(23 + in_x, 28 + in_y, 94, 94, 94);
	gfx.PutPixel(24 + in_x, 28 + in_y, 91, 91, 91);
	gfx.PutPixel(25 + in_x, 28 + in_y, 91, 91, 91);
	gfx.PutPixel(26 + in_x, 28 + in_y, 95, 95, 95);
	gfx.PutPixel(27 + in_x, 28 + in_y, 67, 67, 67);
	gfx.PutPixel(5 + in_x, 29 + in_y, 2, 2, 2);
	gfx.PutPixel(6 + in_x, 29 + in_y, 6, 6, 6);
	gfx.PutPixel(7 + in_x, 29 + in_y, 6, 6, 6);
	gfx.PutPixel(8 + in_x, 29 + in_y, 1, 1, 1);
	gfx.PutPixel(9 + in_x, 29 + in_y, 81, 81, 81);
	gfx.PutPixel(10 + in_x, 29 + in_y, 108, 108, 108);
	gfx.PutPixel(11 + in_x, 29 + in_y, 102, 102, 102);
	gfx.PutPixel(12 + in_x, 29 + in_y, 135, 135, 135);
	gfx.PutPixel(13 + in_x, 29 + in_y, 212, 212, 212);
	gfx.PutPixel(14 + in_x, 29 + in_y, 170, 170, 170);
	gfx.PutPixel(15 + in_x, 29 + in_y, 22, 22, 22);
	gfx.PutPixel(16 + in_x, 29 + in_y, 17, 17, 17);
	gfx.PutPixel(17 + in_x, 29 + in_y, 76, 76, 76);
	gfx.PutPixel(18 + in_x, 29 + in_y, 76, 76, 76);
	gfx.PutPixel(19 + in_x, 29 + in_y, 78, 78, 78);
	gfx.PutPixel(20 + in_x, 29 + in_y, 82, 82, 82);
	gfx.PutPixel(21 + in_x, 29 + in_y, 82, 82, 82);
	gfx.PutPixel(22 + in_x, 29 + in_y, 80, 80, 80);
	gfx.PutPixel(23 + in_x, 29 + in_y, 79, 79, 79);
	gfx.PutPixel(24 + in_x, 29 + in_y, 79, 79, 79);
	gfx.PutPixel(25 + in_x, 29 + in_y, 79, 79, 79);
	gfx.PutPixel(26 + in_x, 29 + in_y, 83, 83, 83);
	gfx.PutPixel(27 + in_x, 29 + in_y, 58, 58, 58);
	gfx.PutPixel(5 + in_x, 30 + in_y, 30, 30, 30);
	gfx.PutPixel(6 + in_x, 30 + in_y, 83, 83, 83);
	gfx.PutPixel(7 + in_x, 30 + in_y, 82, 82, 82);
	gfx.PutPixel(8 + in_x, 30 + in_y, 22, 22, 22);
	gfx.PutPixel(9 + in_x, 30 + in_y, 97, 97, 97);
	gfx.PutPixel(10 + in_x, 30 + in_y, 113, 113, 113);
	gfx.PutPixel(11 + in_x, 30 + in_y, 105, 105, 105);
	gfx.PutPixel(12 + in_x, 30 + in_y, 179, 179, 179);
	gfx.PutPixel(13 + in_x, 30 + in_y, 212, 212, 212);
	gfx.PutPixel(14 + in_x, 30 + in_y, 216, 216, 216);
	gfx.PutPixel(15 + in_x, 30 + in_y, 147, 147, 147);
	gfx.PutPixel(16 + in_x, 30 + in_y, 140, 140, 140);
	gfx.PutPixel(17 + in_x, 30 + in_y, 101, 101, 101);
	gfx.PutPixel(18 + in_x, 30 + in_y, 50, 50, 50);
	gfx.PutPixel(19 + in_x, 30 + in_y, 73, 73, 73);
	gfx.PutPixel(20 + in_x, 30 + in_y, 38, 38, 38);
	gfx.PutPixel(21 + in_x, 30 + in_y, 1, 1, 1);
	gfx.PutPixel(5 + in_x, 31 + in_y, 34, 34, 34);
	gfx.PutPixel(6 + in_x, 31 + in_y, 95, 95, 95);
	gfx.PutPixel(7 + in_x, 31 + in_y, 94, 94, 94);
	gfx.PutPixel(8 + in_x, 31 + in_y, 14, 14, 14);
	gfx.PutPixel(9 + in_x, 31 + in_y, 116, 116, 116);
	gfx.PutPixel(10 + in_x, 31 + in_y, 142, 142, 142);
	gfx.PutPixel(11 + in_x, 31 + in_y, 156, 156, 156);
	gfx.PutPixel(12 + in_x, 31 + in_y, 186, 186, 186);
	gfx.PutPixel(13 + in_x, 31 + in_y, 201, 201, 201);
	gfx.PutPixel(14 + in_x, 31 + in_y, 211, 211, 211);
	gfx.PutPixel(15 + in_x, 31 + in_y, 208, 208, 208);
	gfx.PutPixel(16 + in_x, 31 + in_y, 189, 189, 189);
	gfx.PutPixel(17 + in_x, 31 + in_y, 179, 179, 179);
	gfx.PutPixel(18 + in_x, 31 + in_y, 176, 176, 176);
	gfx.PutPixel(19 + in_x, 31 + in_y, 220, 220, 220);
	gfx.PutPixel(20 + in_x, 31 + in_y, 200, 200, 200);
	gfx.PutPixel(21 + in_x, 31 + in_y, 47, 47, 47);
	gfx.PutPixel(33 + in_x, 31 + in_y, 22, 22, 22);
	gfx.PutPixel(5 + in_x, 32 + in_y, 24, 24, 24);
	gfx.PutPixel(6 + in_x, 32 + in_y, 66, 66, 66);
	gfx.PutPixel(7 + in_x, 32 + in_y, 66, 66, 66);
	gfx.PutPixel(8 + in_x, 32 + in_y, 7, 7, 7);
	gfx.PutPixel(9 + in_x, 32 + in_y, 107, 107, 107);
	gfx.PutPixel(10 + in_x, 32 + in_y, 102, 102, 102);
	gfx.PutPixel(11 + in_x, 32 + in_y, 111, 111, 111);
	gfx.PutPixel(12 + in_x, 32 + in_y, 105, 105, 105);
	gfx.PutPixel(13 + in_x, 32 + in_y, 126, 126, 126);
	gfx.PutPixel(14 + in_x, 32 + in_y, 149, 149, 149);
	gfx.PutPixel(15 + in_x, 32 + in_y, 175, 175, 175);
	gfx.PutPixel(16 + in_x, 32 + in_y, 199, 199, 199);
	gfx.PutPixel(17 + in_x, 32 + in_y, 210, 210, 210);
	gfx.PutPixel(18 + in_x, 32 + in_y, 212, 212, 212);
	gfx.PutPixel(19 + in_x, 32 + in_y, 215, 215, 215);
	gfx.PutPixel(20 + in_x, 32 + in_y, 179, 179, 179);
	gfx.PutPixel(21 + in_x, 32 + in_y, 42, 42, 42);
	gfx.PutPixel(33 + in_x, 32 + in_y, 26, 26, 27);
	gfx.PutPixel(8 + in_x, 33 + in_y, 38, 38, 38);
	gfx.PutPixel(9 + in_x, 33 + in_y, 151, 151, 151);
	gfx.PutPixel(10 + in_x, 33 + in_y, 169, 169, 169);
	gfx.PutPixel(11 + in_x, 33 + in_y, 142, 142, 142);
	gfx.PutPixel(12 + in_x, 33 + in_y, 24, 24, 24);
	gfx.PutPixel(13 + in_x, 33 + in_y, 37, 37, 37);
	gfx.PutPixel(14 + in_x, 33 + in_y, 41, 41, 41);
	gfx.PutPixel(15 + in_x, 33 + in_y, 46, 46, 46);
	gfx.PutPixel(16 + in_x, 33 + in_y, 92, 92, 92);
	gfx.PutPixel(17 + in_x, 33 + in_y, 130, 130, 130);
	gfx.PutPixel(18 + in_x, 33 + in_y, 155, 155, 155);
	gfx.PutPixel(19 + in_x, 33 + in_y, 191, 191, 191);
	gfx.PutPixel(20 + in_x, 33 + in_y, 130, 130, 130);
	gfx.PutPixel(21 + in_x, 33 + in_y, 18, 18, 18);
	gfx.PutPixel(26 + in_x, 33 + in_y, 0, 0, 2);
	gfx.PutPixel(27 + in_x, 33 + in_y, 0, 0, 1);
	gfx.PutPixel(32 + in_x, 33 + in_y, 0, 0, 1);
	gfx.PutPixel(7 + in_x, 34 + in_y, 14, 14, 14);
	gfx.PutPixel(8 + in_x, 34 + in_y, 105, 105, 105);
	gfx.PutPixel(9 + in_x, 34 + in_y, 165, 165, 165);
	gfx.PutPixel(10 + in_x, 34 + in_y, 161, 161, 161);
	gfx.PutPixel(11 + in_x, 34 + in_y, 93, 93, 93);
	gfx.PutPixel(12 + in_x, 34 + in_y, 64, 64, 64);
	gfx.PutPixel(13 + in_x, 34 + in_y, 41, 41, 41);
	gfx.PutPixel(14 + in_x, 34 + in_y, 18, 18, 18);
	gfx.PutPixel(18 + in_x, 34 + in_y, 19, 19, 19);
	gfx.PutPixel(19 + in_x, 34 + in_y, 34, 34, 34);
	gfx.PutPixel(20 + in_x, 34 + in_y, 12, 12, 12);
	gfx.PutPixel(25 + in_x, 34 + in_y, 0, 0, 4);
	gfx.PutPixel(32 + in_x, 34 + in_y, 8, 8, 8);
	gfx.PutPixel(33 + in_x, 34 + in_y, 0, 0, 2);
	gfx.PutPixel(6 + in_x, 35 + in_y, 12, 12, 12);
	gfx.PutPixel(7 + in_x, 35 + in_y, 82, 82, 82);
	gfx.PutPixel(8 + in_x, 35 + in_y, 165, 165, 165);
	gfx.PutPixel(9 + in_x, 35 + in_y, 173, 173, 173);
	gfx.PutPixel(10 + in_x, 35 + in_y, 124, 124, 124);
	gfx.PutPixel(11 + in_x, 35 + in_y, 10, 9, 8);
	gfx.PutPixel(19 + in_x, 35 + in_y, 20, 20, 20);
	gfx.PutPixel(20 + in_x, 35 + in_y, 45, 45, 45);
	gfx.PutPixel(21 + in_x, 35 + in_y, 43, 43, 43);
	gfx.PutPixel(22 + in_x, 35 + in_y, 43, 43, 43);
	gfx.PutPixel(23 + in_x, 35 + in_y, 44, 44, 44);
	gfx.PutPixel(24 + in_x, 35 + in_y, 40, 40, 40);
	gfx.PutPixel(25 + in_x, 35 + in_y, 3, 3, 6);
	gfx.PutPixel(32 + in_x, 35 + in_y, 5, 4, 5);
	gfx.PutPixel(6 + in_x, 36 + in_y, 5, 5, 5);
	gfx.PutPixel(7 + in_x, 36 + in_y, 45, 45, 45);
	gfx.PutPixel(8 + in_x, 36 + in_y, 65, 65, 65);
	gfx.PutPixel(9 + in_x, 36 + in_y, 95, 95, 95);
	gfx.PutPixel(10 + in_x, 36 + in_y, 82, 82, 82);
	gfx.PutPixel(13 + in_x, 36 + in_y, 2, 2, 2);
	gfx.PutPixel(14 + in_x, 36 + in_y, 20, 21, 20);
	gfx.PutPixel(15 + in_x, 36 + in_y, 24, 24, 24);
	gfx.PutPixel(16 + in_x, 36 + in_y, 16, 16, 16);
	gfx.PutPixel(19 + in_x, 36 + in_y, 46, 46, 46);
	gfx.PutPixel(20 + in_x, 36 + in_y, 96, 96, 96);
	gfx.PutPixel(21 + in_x, 36 + in_y, 91, 91, 91);
	gfx.PutPixel(22 + in_x, 36 + in_y, 91, 91, 91);
	gfx.PutPixel(23 + in_x, 36 + in_y, 93, 93, 93);
	gfx.PutPixel(24 + in_x, 36 + in_y, 84, 84, 84);
	gfx.PutPixel(25 + in_x, 36 + in_y, 6, 6, 6);
	gfx.PutPixel(27 + in_x, 36 + in_y, 8, 7, 8);
	gfx.PutPixel(28 + in_x, 36 + in_y, 58, 45, 34);
	gfx.PutPixel(29 + in_x, 36 + in_y, 58, 46, 35);
	gfx.PutPixel(30 + in_x, 36 + in_y, 25, 18, 16);
	gfx.PutPixel(8 + in_x, 37 + in_y, 2, 2, 2);
	gfx.PutPixel(9 + in_x, 37 + in_y, 11, 11, 11);
	gfx.PutPixel(10 + in_x, 37 + in_y, 3, 3, 3);
	gfx.PutPixel(13 + in_x, 37 + in_y, 6, 6, 6);
	gfx.PutPixel(14 + in_x, 37 + in_y, 85, 85, 85);
	gfx.PutPixel(15 + in_x, 37 + in_y, 98, 98, 98);
	gfx.PutPixel(16 + in_x, 37 + in_y, 68, 68, 68);
	gfx.PutPixel(19 + in_x, 37 + in_y, 45, 45, 45);
	gfx.PutPixel(20 + in_x, 37 + in_y, 93, 93, 93);
	gfx.PutPixel(21 + in_x, 37 + in_y, 88, 88, 88);
	gfx.PutPixel(22 + in_x, 37 + in_y, 88, 88, 88);
	gfx.PutPixel(23 + in_x, 37 + in_y, 90, 90, 90);
	gfx.PutPixel(24 + in_x, 37 + in_y, 82, 82, 82);
	gfx.PutPixel(25 + in_x, 37 + in_y, 6, 6, 6);
	gfx.PutPixel(27 + in_x, 37 + in_y, 71, 52, 36);
	gfx.PutPixel(28 + in_x, 37 + in_y, 255, 208, 142);
	gfx.PutPixel(29 + in_x, 37 + in_y, 255, 214, 146);
	gfx.PutPixel(30 + in_x, 37 + in_y, 137, 100, 69);
	gfx.PutPixel(13 + in_x, 38 + in_y, 2, 2, 2);
	gfx.PutPixel(14 + in_x, 38 + in_y, 21, 21, 21);
	gfx.PutPixel(15 + in_x, 38 + in_y, 24, 24, 24);
	gfx.PutPixel(16 + in_x, 38 + in_y, 16, 16, 16);
	gfx.PutPixel(19 + in_x, 38 + in_y, 11, 11, 11);
	gfx.PutPixel(20 + in_x, 38 + in_y, 23, 23, 23);
	gfx.PutPixel(21 + in_x, 38 + in_y, 22, 22, 22);
	gfx.PutPixel(22 + in_x, 38 + in_y, 22, 22, 22);
	gfx.PutPixel(23 + in_x, 38 + in_y, 22, 22, 22);
	gfx.PutPixel(24 + in_x, 38 + in_y, 20, 20, 20);
	gfx.PutPixel(25 + in_x, 38 + in_y, 2, 2, 2);
	gfx.PutPixel(27 + in_x, 38 + in_y, 17, 13, 9);
	gfx.PutPixel(28 + in_x, 38 + in_y, 66, 51, 35);
	gfx.PutPixel(29 + in_x, 38 + in_y, 66, 53, 36);
	gfx.PutPixel(30 + in_x, 38 + in_y, 33, 25, 16);
	gfx.PutPixel(11 + in_x, 40 + in_y, 5, 5, 5);
	gfx.PutPixel(12 + in_x, 40 + in_y, 6, 6, 6);
	gfx.PutPixel(13 + in_x, 40 + in_y, 6, 6, 6);
	gfx.PutPixel(14 + in_x, 40 + in_y, 9, 9, 9);
	gfx.PutPixel(15 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(16 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(17 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(18 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(19 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(20 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(21 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(22 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(23 + in_x, 40 + in_y, 10, 10, 9);
	gfx.PutPixel(24 + in_x, 40 + in_y, 9, 9, 8);
	gfx.PutPixel(25 + in_x, 40 + in_y, 1, 1, 1);
	gfx.PutPixel(10 + in_x, 41 + in_y, 2, 2, 2);
	gfx.PutPixel(11 + in_x, 41 + in_y, 66, 66, 66);
	gfx.PutPixel(12 + in_x, 41 + in_y, 81, 81, 81);
	gfx.PutPixel(13 + in_x, 41 + in_y, 83, 83, 82);
	gfx.PutPixel(14 + in_x, 41 + in_y, 125, 125, 114);
	gfx.PutPixel(15 + in_x, 41 + in_y, 129, 129, 118);
	gfx.PutPixel(16 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(17 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(18 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(19 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(20 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(21 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(22 + in_x, 41 + in_y, 128, 128, 117);
	gfx.PutPixel(23 + in_x, 41 + in_y, 131, 131, 119);
	gfx.PutPixel(24 + in_x, 41 + in_y, 119, 119, 109);
	gfx.PutPixel(25 + in_x, 41 + in_y, 9, 9, 8);
	gfx.PutPixel(10 + in_x, 42 + in_y, 2, 2, 2);
	gfx.PutPixel(11 + in_x, 42 + in_y, 72, 72, 72);
	gfx.PutPixel(12 + in_x, 42 + in_y, 89, 89, 89);
	gfx.PutPixel(13 + in_x, 42 + in_y, 91, 91, 90);
	gfx.PutPixel(14 + in_x, 42 + in_y, 137, 137, 125);
	gfx.PutPixel(15 + in_x, 42 + in_y, 141, 141, 129);
	gfx.PutPixel(16 + in_x, 42 + in_y, 143, 143, 130);
	gfx.PutPixel(17 + in_x, 42 + in_y, 148, 148, 135);
	gfx.PutPixel(18 + in_x, 42 + in_y, 148, 148, 135);
	gfx.PutPixel(19 + in_x, 42 + in_y, 148, 148, 135);
	gfx.PutPixel(20 + in_x, 42 + in_y, 148, 148, 135);
	gfx.PutPixel(21 + in_x, 42 + in_y, 148, 148, 135);
	gfx.PutPixel(22 + in_x, 42 + in_y, 143, 143, 130);
	gfx.PutPixel(23 + in_x, 42 + in_y, 143, 143, 130);
	gfx.PutPixel(24 + in_x, 42 + in_y, 130, 130, 119);
	gfx.PutPixel(25 + in_x, 42 + in_y, 10, 10, 9);
	gfx.PutPixel(10 + in_x, 43 + in_y, 2, 2, 2);
	gfx.PutPixel(11 + in_x, 43 + in_y, 71, 71, 71);
	gfx.PutPixel(12 + in_x, 43 + in_y, 87, 87, 87);
	gfx.PutPixel(13 + in_x, 43 + in_y, 89, 89, 88);
	gfx.PutPixel(14 + in_x, 43 + in_y, 134, 134, 123);
	gfx.PutPixel(15 + in_x, 43 + in_y, 141, 141, 129);
	gfx.PutPixel(16 + in_x, 43 + in_y, 124, 124, 114);
	gfx.PutPixel(17 + in_x, 43 + in_y, 86, 86, 78);
	gfx.PutPixel(18 + in_x, 43 + in_y, 86, 86, 78);
	gfx.PutPixel(19 + in_x, 43 + in_y, 86, 86, 78);
	gfx.PutPixel(20 + in_x, 43 + in_y, 86, 86, 78);
	gfx.PutPixel(21 + in_x, 43 + in_y, 86, 86, 78);
	gfx.PutPixel(22 + in_x, 43 + in_y, 124, 124, 114);
	gfx.PutPixel(23 + in_x, 43 + in_y, 143, 143, 130);
	gfx.PutPixel(24 + in_x, 43 + in_y, 128, 128, 117);
	gfx.PutPixel(25 + in_x, 43 + in_y, 10, 10, 9);
	gfx.PutPixel(10 + in_x, 44 + in_y, 2, 2, 2);
	gfx.PutPixel(11 + in_x, 44 + in_y, 71, 71, 71);
	gfx.PutPixel(12 + in_x, 44 + in_y, 87, 87, 87);
	gfx.PutPixel(13 + in_x, 44 + in_y, 89, 89, 88);
	gfx.PutPixel(14 + in_x, 44 + in_y, 134, 134, 123);
	gfx.PutPixel(15 + in_x, 44 + in_y, 145, 145, 133);
	gfx.PutPixel(16 + in_x, 44 + in_y, 100, 100, 91);
	gfx.PutPixel(22 + in_x, 44 + in_y, 100, 100, 91);
	gfx.PutPixel(23 + in_x, 44 + in_y, 147, 147, 134);
	gfx.PutPixel(24 + in_x, 44 + in_y, 128, 128, 117);
	gfx.PutPixel(25 + in_x, 44 + in_y, 10, 10, 9);
	gfx.PutPixel(10 + in_x, 45 + in_y, 2, 2, 2);
	gfx.PutPixel(11 + in_x, 45 + in_y, 75, 75, 75);
	gfx.PutPixel(12 + in_x, 45 + in_y, 91, 91, 91);
	gfx.PutPixel(13 + in_x, 45 + in_y, 93, 93, 92);
	gfx.PutPixel(14 + in_x, 45 + in_y, 141, 141, 129);
	gfx.PutPixel(15 + in_x, 45 + in_y, 152, 152, 140);
	gfx.PutPixel(16 + in_x, 45 + in_y, 107, 107, 98);
	gfx.PutPixel(22 + in_x, 45 + in_y, 107, 107, 98);
	gfx.PutPixel(23 + in_x, 45 + in_y, 154, 154, 141);
	gfx.PutPixel(24 + in_x, 45 + in_y, 134, 134, 123);
	gfx.PutPixel(25 + in_x, 45 + in_y, 11, 11, 9);
	gfx.PutPixel(10 + in_x, 46 + in_y, 1, 1, 1);
	gfx.PutPixel(11 + in_x, 46 + in_y, 27, 27, 27);
	gfx.PutPixel(12 + in_x, 46 + in_y, 33, 33, 33);
	gfx.PutPixel(13 + in_x, 46 + in_y, 34, 34, 33);
	gfx.PutPixel(14 + in_x, 46 + in_y, 51, 51, 47);
	gfx.PutPixel(15 + in_x, 46 + in_y, 55, 55, 51);
	gfx.PutPixel(16 + in_x, 46 + in_y, 38, 38, 35);
	gfx.PutPixel(22 + in_x, 46 + in_y, 39, 39, 35);
	gfx.PutPixel(23 + in_x, 46 + in_y, 56, 56, 51);
	gfx.PutPixel(24 + in_x, 46 + in_y, 49, 49, 44);
	gfx.PutPixel(25 + in_x, 46 + in_y, 4, 4, 4);
...
void Soldier::HitCrate(Crate & c)
{
	if (c.getState())
	{
		for (auto& el : ps)
		{
			if (el.GetRect().IsOverlappingWith(c.GetRect()))
			{
				el.setOut();
				ChangeWeapon();
				c.setActivated();
